...
from scriptLattes.geradorDePaginasWeb import menuHTMLdeBuscaPB, formataQualis
...
class ResumoExpandidoEmCongresso:
    ...
    def csv(self, nomeCompleto=""):
        ...
        if nomeCompleto == "":  # tratamento grupal
            s += str(
                self.ano) + "\t" + self.titulo + "\t" + self.nomeDoEvento + "\t" + self.autores + "\t" + self.qualis + "\t" + self.qualissimilar
