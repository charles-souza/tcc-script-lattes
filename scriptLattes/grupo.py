...
from scriptLattes.authorRank import AuthorRank
from scriptLattes.charts.graficoDeBarras import GraficoDeBarras
from scriptLattes.charts.graficoDeProporcoes import GraficoDeProporcoes
from scriptLattes.charts.grafoDeColaboracoes import GrafoDeColaboracoes
from scriptLattes.charts.mapaDeGeolocalizacao import MapaDeGeolocalizacao
...
from scriptLattes.geradorDeXML import GeradorDeXML
from scriptLattes.internacionalizacao.analisadorDePublicacoes import AnalisadorDePublicacoes
from scriptLattes.membro import Membro
from scriptLattes.qualis.qualis import Qualis
from scriptLattes.utils import criarDiretorio
...
class Grupo:
    ...
    def gerarArquivoGDF(self, nomeArquivo):
        ...
        for membro in self.listaDeMembros:
            string += "\n" + str(
                i) + "," + membro.idLattes + "," + membro.nomeCompleto + "," + membro.rotulo + "," + membro.enderecoProfissionalLat + "," + membro.enderecoProfissionalLon + ","
        ...
        dir_ = self.obterParametro('global-diretorio_de_saida')
        arquivo = open(dir_ + "/" + nomeArquivo, 'w')
    ...
    @staticmethod
    def imprimeCSVListaIndividual(nomeCompleto, lista):
        s = ""
        for pub in lista:
    ...
    @staticmethod
    def imprimeCSVListaGrupal(listaCompleta):
        s = ""
    ...
    def salvarArquivoGenerico(self, conteudo, nomeArquivo):
        diretorio = self.obterParametro('global-diretorio_de_saida')
