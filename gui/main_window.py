...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.widget_3 = QtGui.QWidget(self.singleTab)
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QtCore.QRect(0, 0, 98, 84))
        ...
        self.widget = QtGui.QWidget(self.multipleTab)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.input_multiple = QtGui.QTextEdit(self.widget)
        ...
        self.folderchooser = QtGui.QPushButton(self.widget)
